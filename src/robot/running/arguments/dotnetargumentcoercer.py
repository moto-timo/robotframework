...
from System import Byte, Int32, Int64, Boolean, Single, Double #Short, Integer, Long, FLoat

from robot.variables import contains_var
from robot.utils import is_list_like


class DotnetArgumentCoercer(object):
...
class IntegerCoercer(_Coercer):
    _name = 'integer'
    _types = [Byte, Int32, Int64] #Short, Integer, Long
    _primitives = ['byte', 'int', 'long'] #'short'
